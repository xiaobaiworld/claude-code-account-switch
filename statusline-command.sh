...
CREDS = 'C:/Users/ALIENWARE/.claude/.credentials.json'
CACHE = 'C:/Users/ALIENWARE/.claude/usage-cache.json'
TTL = 60
...
today=$(date +%Y-%m-%d)
stats_file="/c/Users/ALIENWARE/.claude/stats-cache.json"
...
CREDS = 'C:/Users/ALIENWARE/.claude/.credentials.json'
CACHE = 'C:/Users/ALIENWARE/.claude/profile-cache.json'
TTL = 300  # 5分钟缓存
